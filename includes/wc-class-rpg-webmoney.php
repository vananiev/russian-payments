...
class WC_Rpg_Webmoney extends WC_Rpg_Gateway{

	protected $gateway = 'webmoney';

	public function __construct(){

		$this->id = 'rpg_webmoney';
		$this->icon = RPG_ROOT_URL . '/../assets/img/webmoney.png';
		// Title of the payment method shown on the admin page.
		$this->method_title = 'Webmoney';
		$this->method_description = 'Принимайте оплату с помощью Webmoney '.
